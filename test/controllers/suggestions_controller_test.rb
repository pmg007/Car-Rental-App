...
class SuggestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suggestion" do
    assert_difference('Suggestion.count') do
      post suggestions_url, params: { suggestion: { accepted: @suggestion.accepted, suggestion: @suggestion.suggestion } }
    end
  ...
  test "should update suggestion" do
    patch suggestion_url(@suggestion), params: { suggestion: { accepted: @suggestion.accepted, suggestion: @suggestion.suggestion } }
